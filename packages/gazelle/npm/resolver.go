...
func (s *npmlang) Imports(c *config.Config, r *rule.Rule, f *rule.File) []resolve.ImportSpec {
	// rel := f.Pkg
...
func (s *npmlang) Embeds(r *rule.Rule, from label.Label) []label.Label {
	// npm doesn't have a concept of embedding as far as I know.
	return nil
}
...
func (s *npmlang) Resolve(c *config.Config, ix *resolve.RuleIndex, rc *repo.RemoteCache, r *rule.Rule, importsRaw interface{}, from label.Label) {
